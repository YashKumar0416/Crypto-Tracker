...
export default class App extends Component {
  ...
  fetchData = async() => {
    ...
    this.setState({Id: this.state.Id, Data: datajson})
  }
  ...
  render() {
    return (
      <div>
        ...
        <Cards coinName= {this.state.Data.name} currentPrice={this.state.Data.market_data ? this.state.Data.market_data.current_price["usd"]: ""}
        ...
        <Graphs Id={this.state.Id} priceChange24={this.state.Data.market_data ? this.state.Data.market_data.price_change_24h_in_currency.usd : ""} 
